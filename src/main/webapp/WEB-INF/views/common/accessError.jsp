        ...
        <div class="row justify-content-center w-100">
          <div class="col-lg-4">
            <div class="text-center">
              ...
              <h1 class="fw-semibold my-7 fs-9">접근 권한이 없습니다.</h1>
              <h4 class="fw-semibold mb-7">IT팀에게 문의해주세요.</h4>
              <a class="btn btn-primary" href="${pageContext.request.contextPath }/batirplan/erp/main" role="button">메인으로 이동하기</a>
            </div>
          </div>
        </div>
      </div>
