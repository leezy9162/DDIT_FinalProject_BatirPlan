		...
		<div class="with-vertical">
			...
			<nav class="navbar navbar-expand-lg p-0">
							...
							<div class="dropdown-menu dropdown-menu-nav dropdown-menu-animate-up py-0 overflow-hidden" aria-labelledby="drop2">
								<div class="position-relative">
									<div class="row">
										<div class="col-8">
											<div class="p-4 pb-3">
												<div class="row">
													<div class="col-6">
														<div class="position-relative">													
															<a href="${pageContext.request.contextPath}/batirplan/message/received" class="d-flex align-items-center pb-9 position-relative" _msthidden="2">
						                                    ...
						                                    <div class="d-inline-block" _msthidden="2">
						                                      <h6 class="mb-0" _msttexthash="107510" _msthidden="1" _msthash="176">Message</h6>
						                                      <span class="fs-11 d-block text-body-color" _msttexthash="206284" _msthidden="1" _msthash="177">Get new Message</span>
						                                    </div>
						                                  </a>												
														</div>
													</div>
										...
										<!-- 아이콘 메뉴 마우스 오버시 최우측 배치 이미지 -->
										<div class="col-4">
											<img src="${pageContext.request.contextPath }/assets/images/backgrounds/mega-dd-bg.jpg" alt="mega-dd" class="img-fluid mega-dd-bg" />
										</div>
				...
				<div class="d-block d-lg-none py-9 py-xl-0">
					<img src="${pageContext.request.contextPath }/assets/images/logos/logo.svg" alt="matdash-img" />
				</div>
							...
							<li class="nav-item dropdown">
								<a class="nav-link" href="javascript:void(0)" id="drop1" aria-expanded="false">
									<div class="d-flex align-items-center gap-2 lh-base">
										<img src="${pageContext.request.contextPath }/assets/images/profile/user-1.jpg" class="rounded-circle" width="35" height="35" alt="matdash-img" />
								...
								<div class="dropdown-menu profile-dropdown dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
									<div class="position-relative px-4 pt-3 pb-2">
										<div class="d-flex align-items-center mb-3 pb-3 border-bottom gap-6">
											<img src="${pageContext.request.contextPath }/assets/images/profile/user-1.jpg" class="rounded-circle" width="56" height="56" alt="matdash-img" />
											<div>
												<h5 class="mb-0 fs-12">
												<sec:authentication property="principal.memberVO.ccpyVO.ccpyNm" var="ccpyNm"/>
                       								${ccpyNm} <span class="text-success fs-11">Pro</span>
												</h5>
												<p class="mb-0 text-dark">
												<sec:authentication property="principal.memberVO.ccpyVO.ccpyEmail" var="ccpyEmail"/>
                       								${ccpyEmail}
												</p>
											</div>
										</div>
										...
										<div class="message-body">
											<a href="/batirplan/erp/ccpymypage" class="p-2 dropdown-item h6 rounded-1">
                     							마이 페이지
											</a>
										...
										<div class="dropdown-menu profile-dropdown dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop1">
											<div class="position-relative px-4 pt-3 pb-2">
												<div class="d-flex align-items-center mb-3 pb-3 border-bottom gap-6">
													<img src="${pageContext.request.contextPath }/assets/images/profile/user-1.jpg" class="rounded-circle" width="56" height="56" alt="matdash-img" />
													<div>
														<h5 class="mb-0 fs-12">JiYong Lee <span class="text-success fs-11">Pro</span>
														</h5>
														<p class="mb-0 text-dark">
                              david@wrappixel.com
														</p>
